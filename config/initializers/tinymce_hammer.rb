...
Tinymce::Hammer.init = [
  ...
  [:media_strict, false],
  [:extended_valid_elements, "a[rel|rev|charset|hreflang|tabindex|accesskey|type|name|href|target|title|class|onfocus|onblur|data-formatter],div[data-formatter|data-mysparql-id|data-xslt-type|class|data-parameterised|data-tutorial]"],
  [:theme, 'advanced'],
